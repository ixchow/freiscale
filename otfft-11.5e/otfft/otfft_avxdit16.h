...
struct FFT0
{
    ...
    void fwd(complex_vector x, complex_vector y) const noexcept
    {
        ...
        if (N < OMP_THRESHOLD) {
            ...
            OTFFT_AVXDIT16omp::fwd(log_N, x, y, W);
        else
            OTFFT_AVXDIT16exp::fwd(log_N, x, y);
    }
    ...
    void fwd0(complex_vector x, complex_vector y) const noexcept
    {
        ...
        if (N < OMP_THRESHOLD) {
            ...
            OTFFT_AVXDIT16omp::fwd0(log_N, x, y, W);
        else
            OTFFT_AVXDIT16exp::fwd0(log_N, x, y);
    }
    ...
    void fwdu(complex_vector x, complex_vector y) const noexcept
    {
        ...
        if (N < OMP_THRESHOLD) {
            ...
            OTFFT_AVXDIT16omp::fwdu(log_N, x, y, W);
        else
            OTFFT_AVXDIT16exp::fwdu(log_N, x, y);
    }
    ...
    void inv(complex_vector x, complex_vector y) const noexcept
    {
        ...
        if (N < OMP_THRESHOLD) {
            ...
            OTFFT_AVXDIT16omp::inv(log_N, x, y, W);
        else
            OTFFT_AVXDIT16exp::inv(log_N, x, y);
    }
    ...
    void invu(complex_vector x, complex_vector y) const noexcept
    {
        ...
        if (N < OMP_THRESHOLD) {
            ...
            OTFFT_AVXDIT16omp::invu(log_N, x, y, W);
        else
            OTFFT_AVXDIT16exp::invu(log_N, x, y);
    }
    ...
    void invn(complex_vector x, complex_vector y) const noexcept
    {
        ...
        if (N < OMP_THRESHOLD) {
            ...
            OTFFT_AVXDIT16omp::invn(log_N, x, y, W);
        else
            OTFFT_AVXDIT16exp::invn(log_N, x, y);
    }
};
