...
struct FFT0
{
    ...
    void fwd(complex_vector x, complex_vector y) const noexcept
    {
        ...
        if (N < OMP_THRESHOLD) {
            ...
            OTFFT_AVXDIF16omp::fwd(log_N, x, y, W);
        else
            OTFFT_AVXDIF16exp::fwd(log_N, x, y);
    }
    ...
    void fwd0(complex_vector x, complex_vector y) const noexcept
    {
        ...
        if (N < OMP_THRESHOLD) {
            ...
            OTFFT_AVXDIF16omp::fwd0(log_N, x, y, W);
        else
            OTFFT_AVXDIF16exp::fwd0(log_N, x, y);
    }
    ...
    void fwdu(complex_vector x, complex_vector y) const noexcept
    {
        ...
        if (N < OMP_THRESHOLD) {
            ...
            OTFFT_AVXDIF16omp::fwdu(log_N, x, y, W);
        else
            OTFFT_AVXDIF16exp::fwdu(log_N, x, y);
    }
    ...
    void inv(complex_vector x, complex_vector y) const noexcept
    {
        ...
        if (N < OMP_THRESHOLD) {
            ...
            OTFFT_AVXDIF16omp::inv(log_N, x, y, W);
        else
            OTFFT_AVXDIF16exp::inv(log_N, x, y);
    }
    ...
    void invu(complex_vector x, complex_vector y) const noexcept
    {
        ...
        if (N < OMP_THRESHOLD) {
            ...
            OTFFT_AVXDIF16omp::invu(log_N, x, y, W);
        else
            OTFFT_AVXDIF16exp::invu(log_N, x, y);
    }
    ...
    void invn(complex_vector x, complex_vector y) const noexcept
    {
        ...
        if (N < OMP_THRESHOLD) {
            ...
            OTFFT_AVXDIF16omp::invn(log_N, x, y, W);
        else
            OTFFT_AVXDIF16exp::invn(log_N, x, y);
    }
};
