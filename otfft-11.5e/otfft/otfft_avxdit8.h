...
struct FFT0
{
    ...
    void fwd(complex_vector x, complex_vector y) const noexcept
    {
        ...
        if (N < OMP_THRESHOLD) {
            ...
            OTFFT_AVXDIT8omp::fwd(log_N, x, y, W);
        else
            OTFFT_AVXDIT8exp::fwd(log_N, x, y);
    }
    ...
    void fwd0(complex_vector x, complex_vector y) const noexcept
    {
        ...
        if (N < OMP_THRESHOLD) {
            ...
            OTFFT_AVXDIT8omp::fwd0(log_N, x, y, W);
        else
            OTFFT_AVXDIT8exp::fwd0(log_N, x, y);
    }
    ...
    void fwdu(complex_vector x, complex_vector y) const noexcept
    {
        ...
        if (N < OMP_THRESHOLD) {
            ...
            OTFFT_AVXDIT8omp::fwdu(log_N, x, y, W);
        else
            OTFFT_AVXDIT8exp::fwdu(log_N, x, y);
    }
    ...
    void inv(complex_vector x, complex_vector y) const noexcept
    {
        ...
        if (N < OMP_THRESHOLD) {
            ...
            OTFFT_AVXDIT8omp::inv(log_N, x, y, W);
        else
            OTFFT_AVXDIT8exp::inv(log_N, x, y);
    }
    ...
    void invu(complex_vector x, complex_vector y) const noexcept
    {
        ...
        if (N < OMP_THRESHOLD) {
            ...
            OTFFT_AVXDIT8omp::invu(log_N, x, y, W);
        else
            OTFFT_AVXDIT8exp::invu(log_N, x, y);
    }
    ...
    void invn(complex_vector x, complex_vector y) const noexcept
    {
        ...
        if (N < OMP_THRESHOLD) {
            ...
            OTFFT_AVXDIT8omp::invn(log_N, x, y, W);
        else
            OTFFT_AVXDIT8exp::invn(log_N, x, y);
    }
};
